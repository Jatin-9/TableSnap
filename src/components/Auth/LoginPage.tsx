  ...
  return (
    <div className="min-h-screen bg-gradient-to-br  flex items-center justify-center p-4 dark:bg-gray-900">
      <div className="w-full max-w-md dark:bg-gray-900">
        <div className="text-center mb-8 dark:bg-gray-900">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-2xl mb-4">
            <Table2 className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-4xl font-bold text-gray-900 mb-2 dark:text-white">TableSnap</h1>
          <p className="text-gray-600 dark:text-white">Universal OCR Table Organizer</p>
        </div>

        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-gray-200 dark:bg-gray-900">
